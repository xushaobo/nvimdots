...
local plug_map = {
	...
	-- Plugin: hop
	["nv|<leader>k"] = map_cmd("<Cmd>HopWordMW<CR>"):with_noremap():with_desc("jump: Goto (key)word"),
	["nv|<leader><leader>j"] = map_cmd("<Cmd>HopLineMW<CR>"):with_noremap():with_desc("jump: Goto line"),
